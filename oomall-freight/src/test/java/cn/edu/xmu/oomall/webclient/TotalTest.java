package cn.edu.xmu.oomall.webclient;


import cn.edu.xmu.oomall.OomallOrderFreightApplication;
import cn.edu.xmu.oomall.freight.test.util.JacksonUtil;
...
public class TotalTest {
    ...
    public void defineFreightModel() throws Exception {
        ...
        String json = JacksonUtil.toJson(freightModelDefineRequest);
    ...
    public void defineFreightModel1() throws Exception {
        String token = creatTestToken(1L, 1L, 1000);
        FreightModelDefineRequest freightModelDefineRequest = new FreightModelDefineRequest();
        freightModelDefineRequest.setName("测试模板5");
        freightModelDefineRequest.setType(0);
        freightModelDefineRequest.setUnit(Long.valueOf(500));
        String json = JacksonUtil.toJson(freightModelDefineRequest);
        byte[] responseString = webClient.post().uri("/shops/1/freightmodels").header("authorization",token)
    ...
    public void getFreightModelSummary1() throws Exception {
        ...
        String expectedResponse = "{\"errno\":0,\"errmsg\":\"成功\",\"data\":{\"id\":9,\"name\":\"测试模板\",\"type\":0,\"defaultModel\":1,\"gmtCreate\":[2020,12,2,20,33,8],\"gmtModified\":[2020,12,2,20,33,8]}}";
    ...
    public void getFreightModels() throws Exception {
        ...
        String expectedResponse = "{\"errno\":0,\"errmsg\":\"成功\",\"data\":{\"page\":1,\"pageSize\":10,\"total\":4,\"pages\":1,\"list\":[{\"id\":9,\"name\":\"测试模板\",\"type\":0,\"defaultModel\":1,\"gmtCreate\":[2020,12,2,20,33,8],\"gmtModified\":[2020,12,2,20,33,8]},{\"id\":10,\"name\":\"测试模板2\",\"type\":0,\"defaultModel\":0,\"gmtCreate\":[2020,12,2,20,33,8],\"gmtModified\":[2020,12,2,20,33,8]},{\"id\":11,\"name\":\"测试模板3\",\"type\":0,\"defaultModel\":0,\"gmtCreate\":[2020,12,2,20,33,8],\"gmtModified\":[2020,12,2,20,33,8]},{\"id\":12,\"name\":\"测试模板4\",\"type\":0,\"defaultModel\":0,\"gmtCreate\":[2020,12,2,20,33,8],\"gmtModified\":[2020,12,2,20,33,8]}]}}";
        JSONAssert.assertEquals(expectedResponse, new String(responseString, "UTF-8"), true);
    }
    ...
    public void modifyFreightModel() throws Exception {
        ...
        String json = JacksonUtil.toJson(freightModelPutRequest);
    ...
    public void modifyFreightModel1() throws Exception {
        ...
        FreightModelPutRequest freightModelPutRequest = new FreightModelPutRequest();
        freightModelPutRequest.setName("测试模板3");
